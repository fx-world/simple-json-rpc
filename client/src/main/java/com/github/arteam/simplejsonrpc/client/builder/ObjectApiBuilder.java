...
public class ObjectApiBuilder extends AbstractBuilder implements InvocationHandler {
    ...
    public ObjectApiBuilder(Class<?> clazz, Transport transport, ObjectMapper mapper,
        ...
        this(clazz, transport, mapper, userParamsType, userIdGenerator, true);
    }
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        //  Construct a request
        Object idObject = idGenerator.generate();
        ValueNode id = new POJONode(idObject);
        String textResponse = execute(idObject, request(id, methodName, params));
     ...
     */
    private String execute(Object id, ObjectNode request) {
        try {
            return transport.pass(id, mapper.writeValueAsString(request));
